...
void idle(int value)
{
    ...
    if (rocketStage == 3) {
        ...
        if (rocketPositionY > 2.0f) rocketStage = 4;
    }
...
{
    glutInit(&argc, argv);
    PlaySound("prehistoric.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
    glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB);
    glutInitWindowSize(1200, 700);
    glutCreateWindow("Prehistoric World — OpenGL Graphics Project");
